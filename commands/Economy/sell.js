...
module.exports = {
    ...
    run: async (bot, message, args) => {
      ...
      if(args[0] == 'nikes') {
          ...
          .setColor(red)
          .setDescription(`<a:Crossag:712271469064749066> You don't have Nikes to sell`);
          ...
          .setColor(green)
          .setDescription(`<a:verify5500:698222635091230750> Sold Fresh Nikes For 600 Coins`);
          ...
          let Embed2 = new Discord.RichEmbed()
          .setColor(red)
          .setDescription(`<a:Crossag:712271469064749066> You don't have a Car to sell`);
         ...
         let cars = await db.fetch(`car_${message.guild.id}_${user.id}`)
          ...
          let Embed3 = new Discord.RichEmbed()
          .setColor(green)
          .setDescription(`<a:verify5500:698222635091230750> Sold a Car For 800 Coins`);
          ...
          let Embed2 = new Discord.RichEmbed()
          .setColor(red)
          .setDescription(`<a:Crossag:712271469064749066> You don't have a Mansion to sell`);
          ...
          let Embed3 = new Discord.RichEmbed()
          .setColor(green)
          .setDescription(`<a:verify5500:698222635091230750> Sold a Mansion For 1200 Coins`);
